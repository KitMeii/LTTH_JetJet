...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GiaiDau>(entity => {
            entity.Property(e => e.LePhiGiai).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.TienKyQuy).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.TienPhatTheVang).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.TienPhatTheDo).HasColumnType("decimal(18, 2)");
            entity.HasOne(d => d.SanBong).WithMany()
                .HasForeignKey(d => d.SanBongId)
        ...
        modelBuilder.Entity<DoiBong>(entity => {
            entity.Property(e => e.TienKyQuyConLai).HasColumnType("decimal(18, 2)");
            entity.HasOne(d => d.GiaiDau)
        ...
        modelBuilder.Entity<SuKienTran>(entity => {
            entity.HasOne(d => d.TranDau)
                ...
                .OnDelete(DeleteBehavior.Cascade);
            entity.HasOne(d => d.ThanhVien).WithMany(t => t.SuKiens)
                .HasForeignKey(d => d.ThanhVienId)
                .OnDelete(DeleteBehavior.NoAction);
            entity.HasOne(d => d.Doi).WithMany(b => b.SuKiens)
                .HasForeignKey(d => d.DoiId)
                .OnDelete(DeleteBehavior.NoAction);
        });
        ...
        modelBuilder.Entity<YeuCauDoiGio>(entity =>
        {
            ...
            entity.Property(e => e.NgayMoi).HasColumnType("datetime");
