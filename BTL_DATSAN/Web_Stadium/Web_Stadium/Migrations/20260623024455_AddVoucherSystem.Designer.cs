...
namespace Web_Stadium.Migrations
{
    ...
    [Migration("20260623024455_AddVoucherSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Stadium.EFCore.ChuyenNhuong", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DaChuyenNhuong")
                        .HasColumnType("bit");

                    b.Property<int>("DatSanId")
                        .HasColumnType("int");

                    b.Property<string>("GhiChuOwner")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GhiChuStaff")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("GiaChuyenNhuong")
                        .HasColumnType("decimal(18,0)");

                    b.Property<string>("MoTa")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("OwnerXuLyId")
                        .HasColumnType("int");

                    b.Property<string>("SoDienThoaiLienHe")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("StaffXuLyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OwnerXuLyId");

                    b.HasIndex("StaffXuLyId");

                    b.HasIndex("UserAId");

                    b.HasIndex("UserBId");

                    b.ToTable("ChuyenNhuongs");
                });
            ...
            modelBuilder.Entity("Web_Stadium.EFCore.GhepTran", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DatSanAId")
                        .HasColumnType("int");

                    b.Property<int?>("DatSanBId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DatSanAId");

                    b.HasIndex("DatSanBId");

                    b.HasIndex("KhungGioChonId");

                    b.HasIndex("SanChonId");
            ...
            modelBuilder.Entity("Web_Stadium.EFCore.ChuyenNhuong", b =>
                {
                    ...
                    b.HasOne("Web_Stadium.EFCore.User", "OwnerXuLy")
                        .WithMany()
                        .HasForeignKey("OwnerXuLyId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Web_Stadium.EFCore.User", "StaffXuLy")
                        .WithMany()
                        .HasForeignKey("StaffXuLyId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Web_Stadium.EFCore.User", "UserA")
                        .WithMany()
                        .HasForeignKey("UserAId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Web_Stadium.EFCore.User", "UserB")
                        .WithMany()
                    ...
                    b.Navigation("OwnerXuLy");

                    b.Navigation("StaffXuLy");
            ...
            modelBuilder.Entity("Web_Stadium.EFCore.GhepTran", b =>
                {
                    b.HasOne("Web_Stadium.EFCore.DatSan", "DatSanA")
                        .WithMany()
                        .HasForeignKey("DatSanAId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Web_Stadium.EFCore.DatSan", "DatSanB")
                        .WithMany()
                        .HasForeignKey("DatSanBId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Web_Stadium.EFCore.KhungGio", "KhungGioChon")
                        .WithMany()
                        .HasForeignKey("KhungGioChonId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Web_Stadium.EFCore.SanBong", "SanChon")
                        .WithMany()
                        .HasForeignKey("SanChonId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("DatSanA");

                    b.Navigation("DatSanB");

                    b.Navigation("KhungGioChon");

                    b.Navigation("SanChon");
            ...
            modelBuilder.Entity("Web_Stadium.EFCore.YeuCauDoiSan", b =>
                {
                    ...
                    b.HasOne("Web_Stadium.EFCore.SanBong", "SanMoi")
                        .WithMany()
                        .HasForeignKey("SanMoiId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
