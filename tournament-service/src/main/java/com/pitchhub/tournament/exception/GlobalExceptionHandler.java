...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleTournamentException(TournamentException ex) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest()
                .body(new ApiResponse<>(false, "Du lieu khong hop le", errors, java.time.LocalDateTime.now()));
    }
