...
VALUES
    (N'Giải Hè 2026 — Cầu Giấy Cup',     N'Giải đấu sân 5 hè 2026',           @San1, @IdOwner1, 8,  2, 500000,  2000000, 50000, 200000, 1, 3, DATEADD(DAY, 10, GETDATE()), DATEADD(DAY, 40, GETDATE()),  GETDATE(),                  DATEADD(DAY,  5, GETDATE()), 'RegistrationOpen', @IdStaff1, NULL),
    (N'Đống Đa Arena Champions League',  N'Giải sân 7 cấp khu vực',           @San2, @IdOwner1, 12, 3, 800000,  3000000, 100000,300000, 1, 3, DATEADD(DAY,  5, GETDATE()), DATEADD(DAY, 35, GETDATE()),  GETDATE(),                  DATEADD(DAY,  2, GETDATE()), 'RegistrationOpen', @IdStaff2, NULL),
    ...
    (N'Nam Từ Liêm Premier Cup',         N'Giải sân 7 cao cấp',               @San5, @IdOwner2, 8,  2, 1000000, 3500000, 100000,300000, 1, 3, DATEADD(DAY, 15, GETDATE()), DATEADD(DAY, 45, GETDATE()),  GETDATE(),                  DATEADD(DAY, 10, GETDATE()), 'RegistrationOpen', NULL,       NULL),
    (N'Ba Đình League Mùa Xuân',         N'Giải xuân thường niên',            @San7, @IdOwner3, 6,  1, 300000,  1000000, 50000, 150000, 1, 3, DATEADD(DAY,  3, GETDATE()), DATEADD(DAY, 30, GETDATE()),  GETDATE(),                  DATEADD(DAY,  1, GETDATE()), 'Active', NULL,       NULL),
    (N'Thanh Xuân Cup 2025',             N'Giải đã kết thúc',                 @San8, @IdOwner3, 8,  2, 500000,  2000000, 50000, 200000, 1, 3, DATEADD(DAY,-60, GETDATE()), DATEADD(DAY,-10, GETDATE()),  DATEADD(DAY,-80,GETDATE()), DATEADD(DAY,-65, GETDATE()), 'Finished',  @IdStaff3, NULL),
    (N'Hà Đông Futsal Mini',             N'Giải futsal 4 đội',                @San9, @IdOwner3, 4,  1, 200000,  500000,  30000, 100000, 1, 2, DATEADD(DAY,  7, GETDATE()), DATEADD(DAY, 21, GETDATE()),  GETDATE(),                  DATEADD(DAY,  5, GETDATE()), 'RegistrationOpen', NULL,       NULL),
    ...
    (N'Hoàng Mai Cup Trial',             N'Giải đang chạy thử',               @San3, @IdOwner1, 4,  1, 100000,  300000,  20000, 80000,  1, 2, DATEADD(DAY,  2, GETDATE()), DATEADD(DAY, 12, GETDATE()),  GETDATE(),                  DATEADD(DAY,  1, GETDATE()), 'RegistrationOpen', NULL,       NULL);
PRINT N'✔ GiaiDaus: 10';
